...
export default function AboutPage() {
  return (
    <main>
      {/* ── Section 1: Hero ──────────────────────────────────────────────────── */}
      <section className="relative flex items-center justify-center shadow-md z-20 overflow-hidden" style={{ height: '70vh' }}>
        <div
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none mix-blend-screen">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-teal opacity-50 blur-[120px]" />
          <div className="absolute top-1/3 left-1/3 w-[300px] h-[300px] bg-cyan opacity-20 blur-[90px]" />
        </div>
      ...
      <section className="bg-[#F7F9FA] py-[80px] md:py-[120px] px-[24px]">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-[48px] lg:gap-[80px] items-center">
          <FadeInSection className="relative group p-[20px] bg-white border border-gray-100/50 shadow-md transition-shadow hover:shadow-xl hover:-translate-y-1">
            <div className="grid grid-cols-2 gap-[12px]">
              <div className="col-span-2 overflow-hidden relative h-[240px] md:h-[340px]">
                <Image
              ...
              <div className="overflow-hidden relative h-[160px] md:h-[220px]">
                <Image
          ...
          <FadeInSection delay={0.1}>
            ...
            <div className="mt-[48px] grid grid-cols-1 sm:grid-cols-3 gap-[16px]">
              {[
                ...
                <div key={v.label} className="flex flex-col items-center justify-center p-[32px] bg-white border border-gray-100 shadow-sm transition-all hover:shadow-md hover:-translate-y-1 duration-[350ms] ease-out group/feature">
                  <div className="w-12 h-12 bg-ice flex items-center justify-center text-[20px] mb-[16px] group-hover/feature:bg-lime group-hover/feature:shadow-lime transition-all">
                    {v.emoji}
                  </div>
                  <span className="font-display text-[12px] font-bold tracking-widest uppercase text-void text-center group-hover/feature:text-teal transition-colors">{v.label}</span>
                </div>
              ))}
            </div>
          </FadeInSection>
      ...
      <section className="py-[80px] md:py-[120px] px-[24px] bg-void relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-teal opacity-20 blur-[120px] pointer-events-none" />

        <div className="max-w-[1024px] mx-auto relative z-10">
          <div className="bg-[#1a1620] border border-white/10 overflow-hidden shadow-2xl transition-all duration-500 hover:border-white/20 group/founderBox relative">
            <div className="absolute top-0 right-0 w-[4px] h-full bg-lime scale-y-0 group-hover/founderBox:scale-y-100 origin-bottom transition-transform duration-500" />
            <div className="grid grid-cols-1 lg:grid-cols-5">
              <div className="lg:col-span-2 flex items-center justify-center p-[40px] bg-[#1a1620] relative">
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-teal/10 to-transparent" />
                <div className="relative z-10">
                  <div className="w-[200px] h-[200px] lg:w-[280px] lg:h-[320px] overflow-hidden shadow-2xl group relative border border-white/5">
                    <Image
                      src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&q=80"
                      alt="Kevin — Founder of BagpackerMe"
                      fill
                      className="object-cover transition-transform duration-[800ms] ease-[cubic-bezier(0.25,1,0.5,1)] group-hover/founderBox:scale-[1.05]"
                    />
                  </div>
                  <div className="absolute -bottom-[16px] left-1/2 -translate-x-1/2 bg-lime text-void text-[10px] sm:text-[11px] font-bold font-display tracking-[0.2em] px-[24px] py-[12px] whitespace-nowrap uppercase shadow-lime border-b-[3px] border-void">
                    Founder
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-3 p-[32px] md:p-[48px] flex flex-col justify-center">
                <div className="section-label mb-[12px]">
                   ✦ Meet the Founder
                </div>
                ...
                <div className="flex gap-[12px]">
                  ...
                  <a
                    ...
                    className="w-[48px] h-[48px] border border-white/10 bg-white/5 flex items-center justify-center text-[18px] text-white/70 hover:border-lime hover:bg-lime hover:text-void hover:-translate-y-1 hover:shadow-lime transition-all duration-300"
                  >
                  ...
                  <a
                    ...
                    target="_blank" rel="noopener noreferrer"
                    aria-label="WhatsApp"
                    className="w-[48px] h-[48px] border border-white/10 bg-white/5 flex items-center justify-center text-[18px] text-white/70 hover:border-[#25D366] hover:bg-[#25D366] hover:text-white hover:-translate-y-1 transition-all duration-300"
                  >
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-[18px] h-[18px]">
      ...
      <section className="bg-teal py-[80px] md:py-[120px] px-[24px] relative overflow-hidden">
        ...
        <div className="max-w-[1024px] mx-auto text-center mb-[48px] md:mb-[64px] relative z-10">
          <div className="section-label justify-center text-white before:bg-white mb-[16px]">
             ✦ Impact
          </div>
        ...
        <div className="max-w-[1024px] mx-auto grid grid-cols-2 lg:grid-cols-4 gap-[16px] md:gap-[24px] relative z-10">
          {[
            ...
            <motion.div
              key={stat.label}
              className="p-[32px] text-center flex flex-col items-center gap-[8px] border border-white/10 shadow-lg backdrop-blur-sm transition-transform hover:-translate-y-2 hover:bg-white/10 duration-500 hover:border-lime/30"
      ...
      <section className="py-[80px] md:py-[120px] px-[24px] bg-ice">
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="overflow-hidden shadow-2xl border border-void/10 aspect-video mb-[48px] bg-void/5 hover:shadow-teal transition-shadow duration-700">
            <iframe
      ...
      <section className="py-[80px] md:py-[120px] px-[24px] bg-void relative overflow-hidden">
        ...
        >
          <div className="section-label justify-center text-lime before:bg-lime mb-[24px]">
             ✦ Ready?
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-[16px] justify-center items-center">
            <Link
              href="/packages"
              className="btn-lime px-10 py-5 text-[14px]"
            >
              Explore Trips
            </Link>
            <a
              href="https://wa.me/919920992026"
              target="_blank" rel="noopener noreferrer"
              className="btn-ghost px-10 py-5 text-[14px] border-white/40"
            >
