...
export default function BookingForm({ pkg }: { pkg: Package }) {
  ...
  return (
    <section id="book" className="relative w-full bg-[#221E2A] py-mobile md:py-desktop flex items-center min-h-[800px]">
      {/* Background */}
      ...
      <div className="max-w-7xl mx-auto px-mobile md:px-desktop w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-[64px] items-center">
