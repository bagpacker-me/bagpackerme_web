        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4">
              <a href="https://instagram.com/bagpackerme" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-cyan transition-colors">
              ...
              <a href="https://youtube.com/@bagpackerme" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-cyan transition-colors">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
                  <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z"/>
                  <polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"/>
                </svg>
              </a>
              <a href="https://twitter.com/bagpackerme" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-cyan transition-colors">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://wa.me/919920992026" target="_blank" rel="noopener noreferrer" className="text-white/80 hover:text-cyan transition-colors">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3">
              {exploreLinks.map((link) => (
                <li key={link.name}>
                  <Link href={link.href} className="text-white/80 hover:text-cyan transition-colors text-sm">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div className="space-y-6 flex flex-col items-start lg:col-span-1">
            ...
            <div className="pt-4 w-full">
              ...
              <form className="relative flex items-center w-full max-w-sm rounded-full bg-white/5 border border-white/10 p-1 focus-within:border-cyan/50 focus-within:ring-1 focus-within:ring-cyan/50 transition-all">
                <input 
                  type="email" 
                ...
                <button 
                  ...
                  className="bg-cyan/10 hover:bg-cyan text-cyan hover:text-void p-2 rounded-full transition-colors flex-shrink-0"
                >
