        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center flex-wrap gap-2 text-white/80">
              <a href="https://instagram.com/bagpackerme" target="_blank" rel="noopener noreferrer" className="hover:text-cyan transition-colors min-w-[32px] min-h-[32px] flex items-center justify-center">
              ...
              <a href="https://youtube.com/@bagpackerme" target="_blank" rel="noopener noreferrer" className="hover:text-cyan transition-colors min-w-[32px] min-h-[32px] flex items-center justify-center">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
                  <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z"/>
                  <polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"/>
                </svg>
              </a>
              <a href="https://twitter.com/bagpackerme" target="_blank" rel="noopener noreferrer" className="hover:text-cyan transition-colors min-w-[32px] min-h-[32px] flex items-center justify-center">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="https://wa.me/919920992026" target="_blank" rel="noopener noreferrer" className="hover:text-cyan transition-colors min-w-[32px] min-h-[32px] flex items-center justify-center">
