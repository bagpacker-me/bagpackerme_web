  ...
  return (
    <div className="fixed bottom-6 right-6 z-[999]">
      <div className="relative group flex items-center">
        {/* Tooltip */}
        <div className="absolute right-full mr-4 px-4 py-2 bg-void text-white text-sm font-medium rounded-lg shadow-lg opacity-0 translate-x-2 pointer-events-none group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 whitespace-nowrap">
        ...
        {/* Pulse Ring */}
        <div className="absolute inset-0 bg-[#25D366] rounded-full animate-ping opacity-75 duration-[3000ms]" />
