...
// Initialize Firebase internally so we don't rely on Next.js/window check complications
  ...
  try {
    ...
    for (const pkg of packages) {
      const docData = {
        ...
        overviewHtml: `<p>${pkg.tagline}</p><p>This is a seeded description for ${pkg.title}.</p>`,
        itinerary: [
          {
            day: 1,
