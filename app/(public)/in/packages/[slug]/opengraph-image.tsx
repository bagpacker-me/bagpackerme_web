...
export const alt = 'BagPackerMe India journey';
...
export default async function Image({ params }: { params: { slug: string } }) {
  ...
  if (!pkg) {
    return renderOgCard({ title: 'Experiential India, designed around you' });
  }

  const price = getPackagePrimaryPrice(pkg, 'india').label;
