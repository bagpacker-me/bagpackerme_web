        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <div className="text-center">
            <a
              ...
              className="inline-flex items-center gap-[8px] px-[32px] py-[16px] bg-[#FAF9F6] border border-void/10 rounded-full font-display font-bold tracking-widest uppercase text-[12px] text-teal hover:border-teal hover:bg-teal/5 transition-all group"
            >
              Watch on YouTube
              <svg
      ...
      <section className="py-[80px] md:py-[120px] px-[24px] bg-[#fafafa] border-t border-void/5 relative overflow-hidden">
        ...
        <FadeInSection className="max-w-[800px] mx-auto text-center relative z-10 flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row gap-[16px] justify-center items-center">
            <Link
              href="/packages"
              className="px-[32px] py-[16px] bg-teal text-white font-display font-medium rounded-full hover:bg-teal/90 transition-colors flex items-center gap-[12px] shadow-lg shadow-teal/20 hover:shadow-teal/40"
            >
              Explore Trips
            </Link>
            <a
              href="https://wa.me/919920992026"
              target="_blank" rel="noopener noreferrer"
              className="px-[32px] py-[16px] bg-white border border-void/10 text-void font-display font-medium rounded-full hover:border-[#25D366] hover:text-[#25D366] transition-colors flex items-center gap-[12px]"
            >
